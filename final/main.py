...
def set_random_seed(seed=0):
    ...
    torch.backends.cudnn.benchmark = False     # Disalbe dynamic kernel selection
...
class EarlyStopping:
    ...
    def __init__(self, patience=3, delta=0.01):
        ...
        Args:
            ...
            delta (float): Minimun improvement to qualify as an improvement.
        """
    ...
    def update(self, val_accuracy):
        """Update the early stopping state based on validation accuracy."""
...
class FocalLoss(nn.Module):
    """Implements Focal Loss for handling class imbalance during training."""
